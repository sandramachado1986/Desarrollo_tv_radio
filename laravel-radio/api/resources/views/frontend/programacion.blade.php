...
<div class="card">
  <img   style ="width:50 px; height:220px;"alt=" {!! Str::limit($programacion->programa,30, ' ...') !!}" class="card-img-top" src="{{ asset('storage/app/public/'. $programacion->imagen) }}" alt="Card image cap">
