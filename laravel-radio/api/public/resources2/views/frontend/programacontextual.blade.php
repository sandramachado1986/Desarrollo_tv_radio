...
.card-header
{
  ...
  <body>
    ...
    padding-top: 12%;" alt="Universidad Nacional Mar del Plata" src="../../resources/views/img/logo-universidad-nacional-mdp.png"></a>
		</div>
		<div class="col-md-2">
		</div>
		<div class="col-md-4">
	...
	<div class="row">
        ...
        <p>{{$programa->dia}} </br>
        {{$programa->horario}}</p>
        <p>{{$programa->descripcion_programa}}</p>
         

      @endforeach
<img style ="width:50 px; height:100px;"alt="Bootstrap Image Preview" src="../../public{{$programa->imagen_programa}}">
		</div>
		<div class="col-md-4">
